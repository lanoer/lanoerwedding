...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Entertainment - ' . $soundSystem->name)
@push('meta')
{!! SEO::generate() !!}
@endpush
@push('schema')
        ...
        <div class="banner-head">
            <div class="banner-head-padding banner-head-margin">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12"> <span class="heading-meta">{{ $sound->name }}</span>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 text-center"> <img
                        ...
                        alt="{{ $soundSystem->image_alt_text }}">
