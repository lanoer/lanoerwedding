    ...
    <div class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li class="{{ Route::is('comments') ? 'mm-active' : '' }}">
                            <a href="{{ route('comments') }}" class="waves-effect">
                                ...
                                <span class="badge rounded-pill bg-info float-end">{{ approved_comment()->count()
                                    }}</span>
                                <span>Comments</span>
                            </a>
                        </li>
                ...
                <li class="menu-title">Settings & Configurations</li>
                <li class="{{ Route::is('settings.*') ? 'mm-active' : '' }}">
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li class="{{ Route::is('indexing') ? 'mm-active' : '' }}">
                            <a href="{{ route('indexing') }}" class=" waves-effect">
                                <span>Indexing Google & Bing</span>
                            </a>
