            ...
            <div class="card-body">
                <form action="{{ route('team.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="image_holder mb-2" style="max-width: 250px">
                        <img src="{{ asset('storage/back/images/team/' . old('image')) }}" alt="" class="img-thumbnail"
                            id="image-previewer">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group d-flex justify-content-between">
                        <a href="{{ route('team.list') }}" class="btn btn-warning mt-3"><i class="bx bx-arrow-back"></i>
                            Cancel</a>
...
<script>
    $(document).ready(function() {
            $('input[type="file"][name="image"]').ijaboViewer({
                ...
                imageShape: 'rectangle,square,circle,landscape,portrait',
