                            ...
                            @foreach ($wedding as $wed)
                                <div class="item">
                                    ...
                                    <div class="con">
                                        <span class="category">
                                            <a
                                                href="{{ route('makeup.wedding', ['weddingMakeupSlug' => $wed->weddingMakeups->slug]) }}">{{ $wed->weddingMakeups->name }}</a>
                                        </span>
                                        <h5><a
                                                href="{{ route('makeup.wedding.detail', ['weddingMakeupSlug' => $wed->weddingMakeups->slug, 'slug' => $wed->slug]) }}">{{ $wed->name }}</a>
                                        </h5>
                                        <a
                            ...
                            @foreach ($event as $evt)
                                <div class="item">
                                    ...
                                    <div class="con">
                                        <span class="category">
                                            <a
                                                href="{{ route('makeup.event', ['eventMakeupSlug' => $evt->eventMakeup->slug]) }}">{{ $evt->eventMakeup->name }}</a>
                                        </span>
                                        <h5><a
                                                href="{{ route('makeup.event.detail', ['eventMakeupSlug' => $evt->eventMakeup->slug, 'slug' => $evt->slug]) }}">{{ $evt->name }}</a>
                                        </h5>
                                        <a
        ...
        {{-- <div class="blog-section blog pt-90 pb-90">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="item mb-30 animate-box" data-animate-effect="fadeInLeft">
                            <div class="post-img"> <img src="{{ asset('front/assets/images/blog/1.jpg') }}"
                                    alt="">
                                <div class="date">
