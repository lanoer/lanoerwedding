...
<div id="pwe-main">
    ...
    <div class="portfolio-section portfolio pt-0 pb-60">
                ...
                <div class="col-md-4">
                    <div class="item animate-box" data-animate-effect="fadeInLeft">
                        <div class="portfolio-img">
                            <a href="{{ route('gallery.main.show', $a->slug) }}">
                        ...
                        <div class="content">
                            <h5>
                                <a href="{{ route('gallery.main.show', $a->slug) }}">{{ $a->gallery_name }}</a>
                            </h5>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-center">
            {{ $gallery->links('pagination::simple-bootstrap-4') }}
        </div>
    </div>
    <div class="portfolio-section portfolio pt-0 pb-60">
        <div class="container-fluid">
            <div class="row">
                @foreach ($videosGallery as $v)
                <div class="col-md-4">
                    <style>
                        .video-responsive {
                            position: relative;
        ...
        <div class="text-center">
            {{ $videosGallery->links('pagination::simple-bootstrap-4') }}
        </div>
    </div>
    <!-- Clients -->
