    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('makeup.makeupevent.update', $eventMakeups->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="ckeditor form-control @error('description') is-invalid @enderror" name="description" rows="6"
                                placeholder="Content.." id="description">{!! $eventMakeups->description !!}</textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group d-flex justify-content-between">
                            <a href="{{ route('makeup.event.show', 1) }}" class="btn btn-warning mt-3"><i
