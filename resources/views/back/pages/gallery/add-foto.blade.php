    ...
    <div class="app-container">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('gallery.store-foto.gallery') }}" method="post" id="clientform"
                        class="dropzone" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="mb-3">
                                <label class="form-label">Gallery</label>
                                <select class="form-control" name="gallery_fotos_id" id="gallery_fotos_id"
                                    wire:model='gallery_fotos_id'>
                                    <option value="">-- PILIH Gallery --</option>
                                    @foreach ($gallerys as $al)
                                    @php
                                    $photoCount = $al->FotoGallery()->count(); // Menghitung jumlah foto di album
                                    @endphp
    ...
    document.addEventListener('DOMContentLoaded', function() {
                ...
                if (form) {
                    submitBtn.addEventListener('click', function(event) {
                        ...
                        // Validasi album_id
                        var galleryId = document.getElementById("gallery_fotos_id").value;
                        if (!galleryId) {
                            toastr.error('Gallery harus diisi');
                    ...
                    Dropzone.options.clientform = {
                        ...
                        init: function() {
                            ...
                            this.on("sending", function(file, xhr, formData) {
                                formData.append("gallery_fotos_id", document.getElementById("gallery_fotos_id")
