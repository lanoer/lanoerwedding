...
<div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
        <h4 class="page-title mb-0 font-size-18">Create Slider</h4>
            ...
            <div class="card-body">
                <form action="{{ route('slider.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="image_holder mb-2" style="max-width: 250px">
                        <img src="{{ asset('storage/back/images/slider/' . old('image')) }}" alt=""
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control @error('desc_short') is-invalid @enderror"
                            name="desc_short" placeholder="Content.." id="desc_short" value="{{ old('desc_short') }}">
                        @error('desc_short')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <textarea class="ckeditor form-control @error('desc_long') is-invalid @enderror"
                            name="desc_long" rows="6" placeholder="Content.."
                            id="desc_long">{!! old('desc_long') !!}</textarea>
                        @error('desc_long')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
