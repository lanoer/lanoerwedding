                ...
                <form action="{{ route('entertainment.ceremonialevent.update', $ceremonialEvent->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control @error('description') is-invalid @enderror"
                            ...
                            id="description">{!! $ceremonialEvent->description !!}</textarea>
                        @error('description')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group mb-3 mt-3">
                        ...
                        <input type="text" class="form-control @error('meta_description') is-invalid @enderror"
                            ...
                            value="{{ $ceremonialEvent->meta_description }}">
                    ...
                    <div class="form-group mb-3 mt-3">
                        ...
                        <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror"
                            id="meta_keywords" name="meta_keywords" value="{{ $ceremonialEvent->meta_keywords }}">
                        @error('meta_keywords')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group mb-3 mt-3">
                        ...
                        <input type="text" class="form-control @error('meta_tags') is-invalid @enderror" id="meta_tags"
                            name="meta_tags" value="{{ $ceremonialEvent->meta_tags }}">
                        @error('meta_tags')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
