...
<head>
    ...
    <title>Privacy Policy | Lanoer Wedding</title>
    <style>
        body {
...
<body>
    ...
    <main>
        ...
        <!-- You can now paste the long Privacy Policy HTML content here -->
        <!-- Replace this comment with all the <p>, <ul>, <h2>, etc. tags you already have -->

        <!-- Example (first paragraph only, rest to be inserted below similarly): -->
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Lanoer Wedding.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Lanoer Wedding, accessible from <a
                        href="https://lanoerwedding.com" rel="external nofollow noopener"
                        target="_blank">https://lanoerwedding.com</a></p>
            </li>
            <li>
        ...
        <!-- Continue with your full original content... -->
        <ul>
            <li>By email: admin@lanoerwedding.com</li>
        </ul>
    </main>

    <footer>
        &copy; 2025 Lanoer Wedding. All rights reserved.
    </footer>
</body>
