...
@section('pageTitle', webInfo()->web_name . ' | ' . $pageTitle)
@push('meta')
{!! SEO::generate() !!}
@endpush
@push('schema')
...
<div id="pwe-main">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12"> <span class="heading-meta">.read</span>
                            <h2 class="pwe-heading animate-box" data-animate-effect="fadeInLeft">{{ $pageTitle }}</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="blog-section pt-0 pb-60">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-sm-8" id="post-container">
