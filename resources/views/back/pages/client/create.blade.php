...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Create Client')


@section('pageHeader')
<div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
        <h4 class="page-title mb-0 font-size-18">Create Client</h4>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('client.store') }}" method="POST" enctype="multipart/form-data" id="client-form">
                    @csrf
                    ...
                    <div class="image_holder mb-2" style="max-width: 250px">
                        <img src="{{ asset('storage/back/images/client/' . old('image')) }}" alt=""
    ...
    $(document).ready(function() {
            $('#client-form').on('submit', function() {
                ...
                setTimeout(function() {
                    ...
                    submitBtn.html('<i class="bx bx-save"></i> Create');
                }, 3000);
            });
        });
</script>
