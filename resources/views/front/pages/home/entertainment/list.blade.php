    ...
    <div id="pwe-main">
        ...
        <div class="services-section services pt-0 pb-90">
            <div class="container-fluid">
                ...
                <div class="row">
                    @foreach ($soundSystem as $sound)
                        <div class="col-md-4 animate-box" data-animate-effect="fadeInLeft">
                            <div class="item mb-30">
                                <div class="position-re o-hidden"> <img
                                        src="{{ asset('storage/back/images/entertainment/sound/' . $sound->image) }}"
                                        alt="">
                                </div>
                                <div class="con"> <span class="category">
                                        <a href="services-page.html">{{ $sound->name }}</a>
                                    </span>
                                    <h5><a href="services-page.html">{{ $sound->name }}</a></h5> <a
                        ...
                        <div class="col-md-4 animate-box" data-animate-effect="fadeInLeft">
                            <div class="item mb-30">
                                <div class="position-re o-hidden"> <img
                                        ...
                                        alt=""> </div>
                                <div class="con"> <span class="category">
                                        <a href="services-page.html">{{ $live->name }}</a>
                                    </span>
                                    <h5><a href="services-page.html">{{ $live->name }}</a></h5> <a
                                        href="services-page.html"><i class="ti-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        @foreach ($ceremonySound as $ceremony)
                            <div class="col-md-4 animate-box" data-animate-effect="fadeInLeft">
                                <div class="item mb-30">
                                    <div class="position-re o-hidden"> <img
                                            src="{{ asset('storage/back/images/entertainment/ceremonial/' . $ceremony->image) }}"alt="">
                                    </div>
                                    <div class="con"> <span class="category">
                    ...
                    <div class="row">
                        <div class="col-md-12 owl-carousel owl-theme animate-box" data-animate-effect="fadeInLeft">
                            @foreach ($teamCreative as $team)
                                <div class="item">
                                    <div class="img"> <img src="{{ asset('storage/back/images/team/' . $team->image) }}"
                                            alt=""> </div>
                                    <div class="info">
                                        <h6>{{ $team->name }}</h6>
                                        <p>{{ $team->position }}</p>
