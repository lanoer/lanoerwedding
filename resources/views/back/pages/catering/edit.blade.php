...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Edit Catering')


@section('pageHeader')
<div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
        <h4 class="page-title mb-0 font-size-18">Edit Catering</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Edit Catering</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('catering.main.update', $catering->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('image') is-invalid @enderror" id="image"
                            name="image" value="{{ $catering->image }}">
                        @error('image')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="image_holder mb-2" style="max-width: 250px">
                        <img src="{{ asset('storage/back/images/catering/' . $catering->image) }}" alt=""
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control @error('description') is-invalid @enderror"
                            ...
                            id="description">{!! $catering->description !!}</textarea>
                        @error('description')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
