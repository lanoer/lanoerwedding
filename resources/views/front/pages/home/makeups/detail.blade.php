                        ...
                        <div class="col-md-4 animate-box" data-animate-effect="fadeInLeft">
                            <div class="item mb-30">
                                ...
                                <div class="con">
                                    <span class="category">
                                        <a
                                            href="{{ route('makeup.event', ['eventMakeupSlug' => $eventMakeup->slug]) }}">{{ $eventMakeup->name }}</a>
                                    </span>
                                    <h5><a
                                            href="{{ route('makeup.event', ['eventMakeupSlug' => $eventMakeup->slug]) }}">{{ $event->name }}</a>
                                    </h5>
                                    <a
                                    ...
                                    <div class="social valign">
                                        <div class="full-width">
                                            ...
                                            <a href="{{ $team->tiktok }}" class="social-icon">
                                                <svg width="15" height="15" viewBox="0 0 25 25" fill="black"
                                                    class="fa-lg">
                                                    <path
