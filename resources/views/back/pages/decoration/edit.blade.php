...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Edit Decoration')


@section('pageHeader')
<div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
        <h4 class="page-title mb-0 font-size-18">Edit Decoration</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Edit Decoration</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('decoration.update.decor', $decoration->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                            name="name" value="{{ $decoration->name }}">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control @error('description') is-invalid @enderror"
                            ...
                            id="description">{!! $decoration->description !!}</textarea>
                        @error('description')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group mb-3 mt-3">
                        ...
                        <input type="text" class="form-control @error('meta_description') is-invalid @enderror"
                            id="meta_description" name="meta_description" value="{{ $decoration->meta_description }}">
                    ...
                    <div class="form-group mb-3 mt-3">
                        ...
                        <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror"
                            id="meta_keywords" name="meta_keywords" value="{{ $decoration->meta_keywords }}">
                        @error('meta_keywords')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
