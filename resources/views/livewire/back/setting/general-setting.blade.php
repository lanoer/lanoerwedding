    ...
    <form method="POST" wire:submit.prevent='updateGeneralSettings()'>
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    <label for="name">Web Working Hours</label>
                    <input type="text" class="form-control" placeholder="Enter web working hours"
                ...
                <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                    <span wire:loading wire:target="updateGeneralSettings" class="spinner-border spinner-border-sm"
                        role="status" aria-hidden="true"></span>
                    <span wire:loading.remove wire:target="updateGeneralSettings">Save</span>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    <iframe src="https://www.google.com/maps/embed?pb={{ $web_maps }}" width="100%" height="100%"
                        frameborder="0" style="border:0"></iframe>
                </div>
                <small>Note:
                    <ul>
                        <li>Agar Maps tampil dengan akurat silahkan buka google maps dan cari sematkan peta</li>
                        <li>Kemudian copy paste pada bagian https://www.google.com/maps/embed?pb=<strong
                                class="text-danger">di isi dengan kode selanjutnya,</strong> sampai penutup <strong
