...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Create Ceremonial')


@section('pageHeader')
<div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
        <h4 class="page-title mb-0 font-size-18">Create Ceremonial</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Create Ceremonial</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('entertainment.ceremonial.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <select name="ceremonial_id" id="ceremonial_id" class="form-control">
                    ...
                    <div class="image_holder mb-2" style="max-width: 250px">
                        <img src="{{ asset('storage/back/images/entertainment/ceremonial/' . old('image')) }}" alt=""
...
<script>
    $('#description').summernote({
        ...
        function uploadImage(file) {
            ...
            $.ajax({
                url: 'entertainment/ceremonial/ceremonialevent/upload-image', // Endpoint untuk upload gambar
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
        ...
        function deleteImage(imageUrl) {
            ...
            $.ajax({
                url: 'entertainment/ceremonial/ceremonialevent/delete-image',
                type: 'POST',
                data: {
                    imageUrl: imageUrl,
                    _token: '{{ csrf_token() }}'
